...
| Academics (Context, Structure, Attendance, Scores, Timetable, Homework) | `contracted` | Academic context/grade/class/roster administration, Attendance, and protected student score detail `implemented`; broad Scores/Timetable/Homework surfaces `partial` | Academic years, semesters, grade levels, classes, enrollment history, and student detail reads are live. |
