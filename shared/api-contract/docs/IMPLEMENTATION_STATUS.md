...
| Academics (Context, Structure, Attendance, Scores, Timetable, Homework) | `contracted` | Academic context/grade/class/roster administration, Attendance, score administration, and protected student score detail `implemented`; broad Timetable/Homework surfaces `partial` | Academic years, semesters, grade levels, classes, enrollment history, and student detail reads are live. |
