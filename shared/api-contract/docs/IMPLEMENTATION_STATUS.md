...
| Academics (Context, Attendance, Scores, Timetable, Homework) | `contracted` | Academic context CRUD/current, Attendance, and protected student score detail `implemented`; broad Scores/Timetable/Homework admin surfaces `partial` | Academic years/semesters and student profile attendance/scores are live. Broad admin surfaces remain planned. |
